    ...
    <header className="sticky top-0 z-50 px-2 pt-2 sm:px-4">
      <div
        className={`rounded-2xl ring-1 transition-[background-color,box-shadow,backdrop-filter] duration-500 ${
          scrolled
            ? 'bg-ink-950/80 shadow-2xl shadow-black/40 ring-white/[0.08] backdrop-blur-2xl'
        ...
        <AnimatePresence>
          {mobileOpen && (
            <motion.div
              ...
              className="overflow-hidden rounded-b-2xl border-t border-white/8 bg-ink-950/95 backdrop-blur-2xl lg:hidden"
            >
